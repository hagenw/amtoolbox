...
%hassager2016 - Model for sound externalization
...
%     JND     : ILD JND used as minimum limit for evaluation of ILD devations.
%               Default is 1.5 [dB].
%     c1      : Gain of ILD-deviation-to-externalization mapping function  
%               (decaying exponential) acc. to Eq. (14). Default is 3.78.
%     c2      : Intercept of mapping function (Eq. (14)). Default is 1.
%     z1      : Scaling parameter of mapping function (Eq. (14)).
%               Default is 0.99.
%     flow    : Lowest frequency considered in auditory filterbank.
%               Default is 50 [Hz].
%
