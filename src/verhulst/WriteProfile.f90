...
SUBROUTINE WriteProfile
  ...
  IF (storeProfile) THEN
     ...
     DO i = 1, n, plotEvery_n_points
        ...
        WRITE (FH_profile, '(I7, ES23.7, ES23.7, ES23.7, ES23.7, ES23.7, ES23.7)', IOSTAT = ios) i, & 
             f_resonance(i), MAXVAL(positionMatrix(ii, :)), MAXVAL(velocityMatrix(ii, :)), plotd(i), plots(i), plotdebug(i)
