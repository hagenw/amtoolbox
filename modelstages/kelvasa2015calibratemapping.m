function [mappingData] = kelvasa2015calibratemapping(varargin)
%KELVASA2015CALIBRATEMAPPING  Produces necessary mappings for localization model
%   Usage:[mappingData] = kelvasa2015calibratemapping(varargin)
%
%   Input parameters:
...
% 
% 
%   kelvasa2015calibratemapping(varargin) processes a user specified 
...
[signal, fs] = audioread(kv.localizationModelCalibWav);
...
%Process signal with CI and AN models for right and left channels
    for chan = 1 : 2
        ...
        [electrodogram, vTime] = ...
                                kelvasa2015ciprocessing(HRIR(:,chan),...
...
%Process signal with CI and AN models for right and left channels
        [electrodogram, vTime] = ...
                                kelvasa2015ciprocessing(HRTFsig,...
                                kv.FS_ACE,'argimport',flags,kv);
