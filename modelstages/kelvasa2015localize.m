function [ANbinPredictions, weightedPredictions, mappingData] = ...
            kelvasa2015localize(mappingData, SpkDiffPerBin,...
                                    SpkSumPerBin, varargin)
%KELVASA2015LOCALIZE uses calibration data to map bilateral spike rate 
...
%                             angles over which the signal was processed.
%
%   KELVASA2015localize(APvec,sigLengthSec,varargin)implements a user 
