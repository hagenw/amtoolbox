function h = hohmann2002freqz(obj, z)
%HOHMANN2002FREQZ  Frequency response of hohmann2002 filter or filterbank
%   Usage: h = hohmann2002freqz(filter, z)
%          H = hohmann2002freqz(fb, z)
%
%   `h = hohmann2002freqz(filter, z)` returns the frequency response of
%   filter created by |hohmann2002filter|.
%    
%   `h = hohmann2002freqz(fb, z)` returns the frequency responses of the
...
%
%   Input parameters:
%     filter  : A filter created by |hohmann2002filter|.
