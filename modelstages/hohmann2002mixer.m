function mixer = hohmann2002mixer(fb, delay, iterations)
%HOHMANN2002MIXER Create new mixer object within HOHMANN2002 filterbank framework
%   Usage: mixer = hohmann2002mixer(fb, delay)
%          mixer = hohmann2002mixer(fb, delay, iterations)
%
%   Input parameters:
...
%     delay      : A delay structure as created by |hohmann2002delay|, together
...
%
%   `hohmann2002mixer` creates a mixer object with gain factors suitable
...
% frequencies of all filters (row)
  pos_f = hohmann2002freqz(fb, z_c);
  neg_f = hohmann2002freqz(fb, conj(z_c));
