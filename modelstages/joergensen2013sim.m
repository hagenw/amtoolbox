...
if flags.do_Jetal2013
    ...
    amt_disp(['start Jetal2013: ' datestr(now, 'dd-mm-yyyy HH:MM:SS')],'progress')
...
if flags.do_JandD2011specsub
    load single_150_SentArray22kHz_varLength
    amt_disp(['start JandD2011specsub: ' datestr(now, 'dd-mm-yyyy HH:MM:SS')],'progress')
    sentenceFileLevel = -26;
...
if flags.do_JandD2011reverb
    load single_150_SentArray22kHz_varLength
    amt_disp(['start JandD2011reverb: ' datestr(now, 'dd-mm-yyyy HH:MM:SS')],'progress')
    sentenceFileLevel = -26;
    noise_name = 'SSN_CLUE_22kHz';
    speechSPL = 65;
    SNRs = -9:3:9;
...
if flags.do_FP1990
    ...
    amt_disp(['start FP1990: ' datestr(now, 'dd-mm-yyyy HH:MM:SS')],'progress')
...
if flags.do_Kjems2009
     ...
     amt_disp(['start Kjems2009: ' datestr(now, 'dd-mm-yyyy HH:MM:SS')],'progress')
