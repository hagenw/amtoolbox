%DEMO_DIETZ  XXX Put in a nice title
%
%  This demos loads a simulated binaural recording of multiple persons
%  talking and calculates and plots azimuth histograms and the azimuth over
%  time for the 1-kHz channel (as in Dietz 2011 paper).
%
%  .. figure:
%
%    XXX Caption for figure 1, one line only
%
%    XXX Description of figure 1, may span multiple
%    lines.
%
%  .. figure:
%
%    XXX Caption for figure 2, one line only
%
%    XXX Description of figure 2, may span multiple
%    lines.
% 
...
figure;
hist(angl(hairc_fine.ic>ic_threshold&[diff(hairc_fine.ic)>0; zeros(1,12)]),91);
