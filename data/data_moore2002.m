function data = data_moore2002(varargin)
%
%   Usage:
%     [data] = data_moore2002(varargin)
%     [data] = data_moore2002('tfOuterMiddle1997','fieldType','free')
%     [data] = data_moore2002('tfOuterMiddle1997','fieldType','diffuse')
    ...
    %% Returns transfer function of outer and middle ear as used in moore1997, moore2002
