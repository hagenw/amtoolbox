...
if 0
  definput.keyvals.waveVlat = [10.7666666666667,9.96666666666667, ...
                      9.80000000000000,8.96666666666667,8.03333333333333,8, ...
                      7.93333333333333;10.0333333333333,9.46666666666667, ...
                      8.86666666666667,8.60000000000000,8.50000000000000, ...
                      7.93333333333333,7.86666666666667;9.60000000000000, ...
  ...
  definput.keyvals.click_latency    = [6.76666666666667,6.53333333333334, ...
...
set(gca,'fontsize',12),
semilogx(CF, waveVlat(:,1),'-ko','linewidth',2),hold on,
...
[F, tau]  = data_neely1988('F',1e3:8e3,'L',40:10:100);
hold on, semilogx(F,tau','k--'),
text(10e3,8, 'Click','fontsize',12)
hold on; plot(12e3, [5.9, 6.6, 7.6],'ok','MarkerFaceColor','k')
text(13e3,5.88, '95.2')
text(13e3,6.59, '75.2')
text(13e3,7.6, '55.2')
...
% Plot init
box on, ylabel('Latency of wave V [ms]'),xlabel('Frequency of toneburst [kHz]')
set(gca,'fontsize',12); set(gca,'XTick',CF,'XTickLabel',CF/1000),
set(gca,'YTick',1:15,'YTickLabel',1:15), axis([800 16000 5.5 12.5])
